...
var _notificationsJs = require("./lib/notifications.js");
var _userPreferencesJs = require("./lib/userPreferences.js");
 ...
 */ const userPreferences = (0, _userPreferencesJs.getUserPreferences)();
let isTimerActive = false;
// Checks the timer type radio button linked to the selected timer type.
[
    ...timerTypeInputs
].find((element)=>timerTypeValues.get(element.value) === userPreferences.selectedTimerType).checked = true;
 ...
 */ const updateProgressRing = (percent)=>{
    if (progressRingCircumference === null) initialiseProgressRing();
 ...
 */ const startTimer = ()=>{
    ...
    timeoutId = setTimeout(()=>{
        resetTimer();
        (0, _notificationsJs.notifyTimerEnded)();
 ...
 */ const onTimerButtonClick = ()=>{
    if (!isTimerActive && remainingTime > 0) startTimer();
    else if (!isTimerActive && remainingTime === 0) restartTimer();
    else pauseTimer();
};
/**
 * @function
 ...
 */ const processFormData = (form)=>{
    const font = [
        ...form.querySelectorAll('input[type="radio"][name="font"]')
    ].find((input)=>input.checked).value;
    const accentColor = [
        ...form.querySelectorAll('input[type="radio"][name="accent-color"]')
    ].find((input)=>input.checked).value;
    const formData = {
 ...
 */ const onSettingsFormSubmit = (event)=>{
    ...
    (0, _userPreferencesJs.saveUserPreferences)(userPreferences);
 ...
 */ const onTimerTypeChange = ({ target: { value  }  })=>{
    if (!timerTypeValues.has(value)) return;
 ...
 */ const startup = ()=>{
    ...
    (0, _notificationsJs.requestNotificationPermission)();
};
startup();

},{"./lib/notifications.js":"kYOkk","./lib/userPreferences.js":"kGfUS"}],"kYOkk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "requestNotificationPermission", ()=>requestNotificationPermission);
parcelHelpers.export(exports, "notifyTimerEnded", ()=>notifyTimerEnded);
let areNotificationsGranter = false;
const requestNotificationPermission = ()=>{
    if (Notification.permission === "default") Notification.requestPermission().then((result)=>{
        console.log(result);
    });
};
...
},{}],"kGfUS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saveUserPreferences", ()=>saveUserPreferences);
parcelHelpers.export(exports, "getUserPreferences", ()=>getUserPreferences);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire1642")
